...
define('G5_MYSQL_USER', 'ghol7416open');
define('G5_MYSQL_PASSWORD', 'park64911*');
define('G5_MYSQL_DB', 'ghol7416open');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'ee2a066cc27755a3000602a2cc8922a3'); // 토큰 암호화에 사용할 키
